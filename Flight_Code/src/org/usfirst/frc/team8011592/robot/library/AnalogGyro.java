...
* $HeadURL: https://ks-kdc-firs1001.ndc.nasa.gov/svn/robotics/2015_Season/Competition_Software/trunk/Flight_Code/src/org/usfirst/frc/team8011592/robot/library/AnalogGyro.java $
* $Author: dedyer1 $
*/
...
/**
 *
//public class newGyro extends Subsystem {
 ...
 */
public class AnalogGyro extends SensorBase implements PIDSource, LiveWindowSendable {
	...
	private static AnalogInput m_analog;
	...
	public double getAngle() {
		...
		if (m_analog == null) {
            ...
            // move output to heading in range 0-360 not including 360
			/*result1 = (int) (scaledValue/360);
			if (scaledValue >= 360)
			{
				scaledValue -= 360*result1;
...
//			}*/
			scaledValue = scaledValue % 360.0;
			if (scaledValue < 0){
				scaledValue+=360;
			}
			//*************************************
			return scaledValue + Constants.HEADING_OFFSET;
		}
	}
	...
	//	case PIDSourceParameter.kRate_val:
			return getRate();
		//case PIDSourceParameter.kAngle:
		case 2:
			return getAngle();
		default:
			return 0.0;
