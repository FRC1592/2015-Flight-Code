 ...
 * which uses a single {@link PIDController1592} almost constantly (for instance,
 * an elevator which attempts to stay at a constant height).
 *
 * <p>It provides some convenience methods to run an internal {@link PIDController1592}.
 * It also allows access to the internal {@link PIDController1592} in order to give total control
 * to the programmer.</p>
 *
 * @author Joe Grinstead
 */
public abstract class PIDSubsystem1592 extends Subsystem implements Sendable {

    /** The internal {@link PIDController1592} */
    private PIDController1592 controller;
     ...
     */
    public PIDSubsystem1592(String name, double p, double i, double d) {
        super(name);
        controller = new PIDController1592(p, i, d, source, output);
    }
     ...
     */
    public PIDSubsystem1592(String name, double p, double i, double d, double f) {
        super(name);
        controller = new PIDController1592(p, i, d, f, source, output);
    }
     ...
     */
    public PIDSubsystem1592(String name, double p, double i, double d, double f, double period) {
        super(name);
        controller = new PIDController1592(p, i, d, f, source, output, period);
    }
     ...
     * @param d the derivative value
     */
    public PIDSubsystem1592(double p, double i, double d) {
        controller = new PIDController1592(p, i, d, source, output);
    }
     ...
     * @param period the time (in seconds) between calculations
     */
    public PIDSubsystem1592(double p, double i, double d, double period, double f) {
        controller = new PIDController1592(p, i, d, f, source, output, period);
    }
     ...
     * @param period the time (in seconds) between calculations
     */
    public PIDSubsystem1592(double p, double i, double d, double period) {
        controller = new PIDController1592(p, i, d, source, output, period);
    }

    /**
     * Returns the {@link PIDController1592} used by this {@link PIDSubsystem}.
     * Use this if you would like to fine tune the pid loop.
     *
     * @return the {@link PIDController1592} used by this {@link PIDSubsystem}
     */
    public PIDController1592 getPIDController() {
        return controller;
    }
    ...
    */
    ...
    /**
     * Enables the internal {@link PIDController1592}
     */
    public void enable() {
        controller.enable();
    }
    ...
    /**
     * Disables the internal {@link PIDController1592}
     */
    public void disable() {
        controller.disable();
    }
