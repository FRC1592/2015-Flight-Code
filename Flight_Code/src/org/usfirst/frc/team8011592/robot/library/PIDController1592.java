 ...
 * PIDOutput
 */
public class PIDController1592 implements LiveWindowSendable, Controller1592 {
    ...
    private class PIDTask extends TimerTask {
        ...
        private PIDController1592 m_controller;

        public PIDTask(PIDController1592 controller) {
            if (controller == null) {
     ...
     */
    public PIDController1592(double Kp, double Ki, double Kd, double Kf,
     ...
     * integral and differential terms. The default is 50ms.
     */
    public PIDController1592(double Kp, double Ki, double Kd,
                         PIDSource source, PIDOutput output,
                         double period) {
        ...
        if (enabled) {
          double input;
            ...
            synchronized (this) {
                ...
                if (m_I != 0) {
                    double potentialIGain = (m_totalError + m_error) * m_I + m_P * m_error;
    ...
    */
    ...
    /**
     * Returns error accumulated by the integrator
     * @return the integral error
     */
    public synchronized double getIntError() {
    	return m_totalError;
    }
