 ...
 *
 */
public class SetStackHeight extends Command {

	private double m_cmd;

	public SetStackHeight(double cmd) {
		m_cmd = cmd;
	}
	...
	protected void initialize() {
		...
		Robot.stacker.setSetpoint(m_cmd);
		Robot.stacker.setToteState();
		// if(RobotMap.logFile != null) {
		// RobotMap.logFile.writeEventFRC(getName() + " " + m_cmd,
