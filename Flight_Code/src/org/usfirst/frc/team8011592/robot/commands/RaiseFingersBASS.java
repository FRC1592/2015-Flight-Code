 ...
 *
 */
public class RaiseFingersBASS extends Command {

	public RaiseFingersBASS() {
		requires(Robot.bassFingers);
	}

	// Called just before this Command runs the first time
	protected void initialize() {
		Robot.bassFingers.retractBASSTopPiston();
	}
	...
	protected void end() {
		Robot.bassFingers.extendBASSTopPiston();
	}
